...
class geargripv2:
    ...
    To use the pipeline first create a geargripv2 instance and set the sources,
    ...
    def __init__(self):
        ...
        self.__hsl_threshold_hue = [80.93525450006663, 176.9283452213014]
        self.__hsl_threshold_saturation = [146.85727568863996, 255.0]
        self.__hsl_threshold_luminance = [110.98920994525332, 235.85326888048613]
        ...
        self.__filter_contours_solidity = [49.64028931350159, 100.0]
