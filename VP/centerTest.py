...
class centerTest:
    ...
    To use the pipeline first create a centerTest instance and set the sources,
    ...
    def __init__(self):
        ...
        self.__hsl_threshold_hue = [81.0, 177.0]
        self.__hsl_threshold_saturation = [147.0, 255.0]
        self.__hsl_threshold_luminance = [111.0, 236.0]
