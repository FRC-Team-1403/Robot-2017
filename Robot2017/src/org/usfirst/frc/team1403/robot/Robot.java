...
public class Robot extends IterativeRobot {
	...
	public static FlyWheel fw;
	public static OI oi;
	public static Intake take;
	...
	public void robotInit() {
		SmartDashboard.putNumber("joyval", 0);
		dt = new DriveTrain();
		fw = new FlyWheel();
		take = new Intake();
		oi = new OI();
	...
	public void teleopPeriodic() {
		//SmartDashboard.putNumber("velocity", Robot.fw.v.getEncVelocity());
		Scheduler.getInstance().run();
		//SmartDashboard.putNumber("joy", oi.stick2.getRawAxis(1))
